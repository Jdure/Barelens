...
export function About({ data }: Images) {
    ...
    return (
        <div className="flex flex-row mt-12 py-4 bg-[#FFF6EA]">
            <div className="flex flex-col mb-4 sm:items-center basis-1/2">
                <h2 className="text-md text-stone-800 leading-normal lowercase text-center text-2xl sm:grow sm:mb-8 sm:text-5xl ">
            ...
            <div className="flex flex-col basis-1/2 items-center justify-between sm:justify-center sm:space-y-8">
                ...
                />
                <p className="text-xs text-stone-800 text-center sm:text-xl md:text-2xl sm:text-center sm:leading-relaxed md:w-2/3">
